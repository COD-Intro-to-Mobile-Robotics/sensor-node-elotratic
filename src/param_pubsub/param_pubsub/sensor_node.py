...
from std_msgs.msg import Bool # from standard messages, import the String message
...
class SensorNode(Node):   # Create a new class called SensorNode that inherits variables & functions from Node
    ...
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(Bool, 'param_topic', 10)  # Create a publisher for Bool type messages on the topic 'my_topic'
