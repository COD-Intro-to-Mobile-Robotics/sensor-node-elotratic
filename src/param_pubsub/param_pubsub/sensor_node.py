...
class SensorNode(Node):   # Create a new class called SensorNode that inherits variables & functions from Node
    ...
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(Int16, 'param_topic', 10)  # Create a publisher for Int16 type messages on the topic 'my_topic'
    ...
    def timer_callback(self):
        ...
        msg = Int16()                                          # Create a new String message
        msg.data = int(my_param)                                     # set msg.data to have the value of my_param
